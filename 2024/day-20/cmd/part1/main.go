...
func run() error {
	// file, err := os.Open("./assets/input_small.txt") // savingCounts: map[2:14 4:14 6:2 8:4 10:2 12:3 20:1 36:1 38:1 40:1 64:1]
	file, err := os.Open("./assets/input.txt") // 1452
	if err != nil {
	...
	savings := findCheatSavings(path, dists, 2)
